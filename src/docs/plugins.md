...
<p class="flex items-center mt-8 -mb-2">
  ...
  <strong class="font-semibold text-gray-600">Don't use the config function to look up variants</strong>
</p>
...
<p class="flex items-center mt-8 -mb-2">
  ...
  <strong class="font-semibold text-gray-600">Do use the variants function instead</strong>
</p>
